...
public class udpthread implements Runnable
{
	...
	public String recvHexData(int len)
	{
	...
	{
		String val=s.subSequence(22,24).toString();
	...
	public int recvData()
	{
		try
		{
			...
			if (true)
				...
				sRecvData = new String(rPacket.getData(),currentRCodes).trim();return getValue(sRecvData);
